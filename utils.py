        ...
        cell_types_json.append(
            {
                "id": cell_type_id,
                "cells": cells,
                "color": constants.COLOR_MAP[counter],
                "name": mapper[cell_type_id],
                "feature": 0,
            }
        )
        counter += 1
        ...
        cell_types_json.append(
            {
                "id": i,
                "cells": cells,
                "color": constants.COLOR_MAP[i - 1],
                "name": constants.MASTER_TYPES[i - 1],
                "feature": 0,
            }
        )
    return cell_types_json
        ...
        cell_types_json.append(
            {
                "id": i + 1,
                "cells": [],
                "color": constants.COLOR_MAP[(i - 1) % len(constants.COLOR_MAP)],
                "name": channels[i],
                "feature": 0,
            }
        )
...
def tile_around_center(array, num_tiles, size_x, size_y):
    ...
    crop = array[
        :,
        :,
        center_y - int(num_tiles * size_y / 2) : center_y + int(num_tiles * size_y / 2),
        ...
        for j in range(num_tiles):
            batches.append(
                crop[
                    :,
                    0,
                    i * size_y : i * size_y + size_y,
                    j * size_x : j * size_x + size_x,
                ]
            )
    print(batches)
